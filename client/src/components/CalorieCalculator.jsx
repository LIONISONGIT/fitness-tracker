        ...
        <div className="card max-w-2xl mx-auto">
            ...
            <form onSubmit={calculateCalories} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-medium mb-1 text-gray-300">Age (years)</label>
            ...
            {result && (
                <div className="mt-8 p-4 bg-dark rounded-lg border border-gray-700 animate-fade-in">
                    <h3 className="text-xl font-bold mb-4 text-center">Your Results</h3>
                    <div className="grid grid-cols-2 gap-4 text-center">
                        <div className="p-3 bg-card rounded-lg">
                            <p className="text-sm text-gray-400">BMR (Basal Metabolic Rate)</p>
                            <p className="text-2xl font-bold text-secondary">{result.bmr} <span className="text-sm font-normal text-gray-400">kcal</span></p>
                        </div>
                        <div className="p-3 bg-card rounded-lg border border-primary/30">
                            <p className="text-sm text-gray-400">Maintenance Calories (TDEE)</p>
                            <p className="text-2xl font-bold text-primary">{result.tdee} <span className="text-sm font-normal text-gray-400">kcal</span></p>
                        </div>
                    </div>
