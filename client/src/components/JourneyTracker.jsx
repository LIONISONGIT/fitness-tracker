    ...
    return (
        <div className="card max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
                ...
                {entries.length === 0 ? (
                    <p className="text-gray-500 text-center py-8">No entries yet. Start tracking today!</p>
                ) : (
                    <div className="max-h-64 overflow-y-auto pr-2 space-y-2 custom-scrollbar">
                        {entries.map((entry) => (
                            <div key={entry.id} className="flex justify-between items-center p-3 bg-dark rounded-lg border border-gray-800">
